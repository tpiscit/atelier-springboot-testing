package fr.liksi.parcmanager.external.stub;
 ...
 * résolution des réponses au {@link DinoTypeStub}. Le test n'interagit jamais
 * directement avec le MockWebServer : il alimente le stub, et le dispatcher
 * lit le stub à chaque requête entrante.
 *
 * <ul>
 *   <li>UUID trouvé dans le stub → HTTP 200 + JSON (gabarit
...
public class DinoTypeMockWebServerDispatcher extends Dispatcher {
    ...
    private final DinoTypeStub stub;

    public DinoTypeMockWebServerDispatcher(DinoTypeStub stub) {
        this.stub = stub;
    }
