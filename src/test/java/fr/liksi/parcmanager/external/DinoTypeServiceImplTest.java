...
import fr.liksi.parcmanager.external.stub.DinoTypeMockWebServerDispatcher;
import fr.liksi.parcmanager.external.stub.DinoTypeStub;
...
class DinoTypeServiceImplTest {
    ...
    private static DinoTypeApiClient dinoTypeApiClient(MockWebServer server) {
    ...
    void shouldReturnEmptyWhen404() {
        // Given : aucun dino enregistré dans le stub -> l'API répond 404
    ...
    void shouldPropagateServerErrors() {
        ...
        // When & Then
        // Avec le vrai client HTTP, un 500 est une HttpServerErrorException
        // (la version mockée affirmait à tort une HttpClientErrorException)
